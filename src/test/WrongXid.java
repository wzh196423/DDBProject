...
public class WrongXid {
    ...
    public static void main(String args[]) throws URISyntaxException {
        classpath = new File(WrongXid.class.getClassLoader().getResource("").toURI()).getPath();
        ...
        try {
            int xid = wc.start();
            wc.addFlight(367162813, "testNum",100, 300);
            System.out.println("Expect to catch exception but can't!");

        } catch (InvalidTransactionException e1){
            System.out.println("Expected exception catch!");
        ...
        System.out.println("WrongXid pass!");
        dieAll();
