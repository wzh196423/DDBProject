 ...
 */
public class AddAndQueryBeforeCommit {
    ...
    public static void main(String args[]) throws URISyntaxException {
        classpath = new File(AddAndQueryBeforeCommit.class.getClassLoader().getResource("").toURI()).getPath();
        ...
        try {
            ...
            e.printStackTrace();
            fail("AddAndQueryBeforeCommit fail!");
        }

        System.out.println("AddAndQueryBeforeCommit pass!");
        dieAll();
