...
/**
 * Created by wangziheng on 2019/7/30.
 */
public class ReserveItineraryLockTest3 {
        ...
        public void run() {
            synchronized (lock) {
                ...
                try {
                    ...
                    System.out.println("Transaction " + xid + " start failed");
                    dieAll();
                }
                ...
                try {
                    if (wc.queryCustomerBill(xid, "John") != 0){
                        System.out.println("queryCustomerBill fail! xid = " + xid);
                        dieAll();
                    }
                } catch (Exception e) {
                    System.out.println("queryCustomerBill Exception! xid = " + xid);
                }
                lock.set(false);
                lock.notifyAll();
    ...
    public static void main(String args[]) throws URISyntaxException, InterruptedException {
        classpath = new File(ReserveItineraryLockTest3.class.getClassLoader().getResource("").toURI()).getPath();
        ...
        synchronized (lock) {
            ...
            try {
                ...
                System.out.println("reserveItinerary = " + xid);

            } catch (Exception e) {
                System.out.println("reserveItinerary Exception");
                dieAll();
            }
            lock.set(true);
            lock.notifyAll();
        ...
        System.out.println("ReserveItineraryLockTest3 pass!");
        dieAll();
