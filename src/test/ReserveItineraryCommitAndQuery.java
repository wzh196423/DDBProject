 ...
 */
public class ReserveItineraryCommitAndQuery {
    ...
    public static void main(String args[]) throws URISyntaxException {
        classpath = new File(ReserveItineraryCommitAndQuery.class.getClassLoader().getResource("").toURI()).getPath();
        ...
        try {
            ...
            if (wc.queryRooms(xid, "Stanford") != 199)
            ...
            if (wc.queryCustomerBill(xid, "John") != 3561)
                fail("queryCustomerBill fail. xid = " + xid);

        }
        catch (Exception e) {
            e.printStackTrace();
            fail("ReserveItineraryCommitAndQuery fail!");
        }

        System.out.println("ReserveItineraryCommitAndQuery pass!");
        dieAll();
